...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Parse and analyze simulation data.

        \bigskip

        \item Look for correlations between observables and suggest improvements to model.
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Lars is supervisor for {\bf Ising-model} and {\bf Chemical Shifts Study}.
