...
We have measured that the length of the pendulum to be $L = 50m$.

\begin{enumerate}

    \item Load in the datafile

    \item Plot the time vs datapoint id
...
Next we should look at how the datapoints deviate from the fit.
