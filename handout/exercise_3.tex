...
\begin{enumerate}[resume]
    ...
    \item Create a new function and name it \code{velo\_verlet}.
        ...
        The new function should return the positions, velocities, forces and the energy of the system.
...
\begin{enumerate}[resume]
    ...
    \item Plot the energy using another python script and see if the potential energy is roughly conserved over time.
